    ...
    case 2:
      for (byte MixerColumn = 0; MixerColumn < 4; MixerColumn++) {
        ...
        if (NFX3[NFX3presetNr].Pot_Value_graph[MixerColumn + 8] != Potentiometer[MixerColumn]) {
          ...
          drawPot(MixerColumnPos, CTRL_ROW_2, NFX3[NFX3presetNr].Pot_Value_graph[MixerColumn + 8], NFX3[NFX3presetNr].Pot_Value_graph[MixerColumn + 8], NFX3_ROW3[MixerColumn], trackColor[desired_instrument]);
        }
      }
      break;
    ...
    case 3:
      for (byte MixerColumn = 0; MixerColumn < 4; MixerColumn++) {
        ...
        if (NFX3[NFX3presetNr].Pot_Value_graph[MixerColumn + 12] != Potentiometer[MixerColumn]) {
          ...
          drawPot(MixerColumnPos, CTRL_ROW_3, NFX3[NFX3presetNr].Pot_Value_graph[MixerColumn + 12], NFX3[NFX3presetNr].Pot_Value_graph[MixerColumn + 12], NFX3_ROW4[MixerColumn], trackColor[desired_instrument]);
        }
      }
      break;
  }
...
void NoteFX3_Page_Static(byte Pagenumber) {
  clearWorkSpace();
  NoteFX3_Change();
  ...
  for (byte touchX = 1; touchX < 5; touchX++) {
    drawPot(touchX * 4 - 1, CTRL_ROW_2, NFX3[NFX3presetNr].Pot_Value_graph[touchX + 7], NFX3[NFX3presetNr].Pot_Value_graph[touchX + 7], NFX3_ROW3[touchX -1], trackColor[desired_instrument]);
  }
  for (byte touchX = 1; touchX < 5; touchX++) {
    drawPot(touchX * 4 - 1, CTRL_ROW_3, NFX3[NFX3presetNr].Pot_Value_graph[touchX + 11], NFX3[NFX3presetNr].Pot_Value_graph[touchX + 11], NFX3_ROW4[touchX -1], trackColor[desired_instrument]);
  }
}
