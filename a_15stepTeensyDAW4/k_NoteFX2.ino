    ...
    case 1:
      for (int MixerColumn = 0; MixerColumn < 4; MixerColumn++) {
        ...
        if (NFX2[NFX2presetNr].Pot_Value_graph[MixerColumn + 4] != Potentiometer[MixerColumn]) {
          ...
          drawPot(MixerColumnPos, CTRL_ROW_1, NFX2[NFX2presetNr].Pot_Value_graph[MixerColumn + 4], NFX2[NFX2presetNr].Pot_Value_graph[MixerColumn + 4], noteNames[MixerColumn], trackColor[desired_instrument]);
        }
      }
      break;
    ...
    case 2:
      for (int MixerColumn = 0; MixerColumn < 4; MixerColumn++) {
        ...
        if (NFX2[NFX2presetNr].Pot_Value_graph[MixerColumn + 8] != Potentiometer[MixerColumn]) {
          ...
          drawPot(MixerColumnPos, CTRL_ROW_2, NFX2[NFX2presetNr].Pot_Value_graph[MixerColumn + 8], NFX2[NFX2presetNr].Pot_Value_graph[MixerColumn + 8], noteNames[MixerColumn+4], trackColor[desired_instrument]);
        }
      }
      break;
    ...
    case 3:
      for (int MixerColumn = 0; MixerColumn < 4; MixerColumn++) {
        ...
        if (NFX2[NFX2presetNr].Pot_Value_graph[MixerColumn + 12] != Potentiometer[MixerColumn]) {
          ...
          drawPot(MixerColumnPos, CTRL_ROW_3, NFX2[NFX2presetNr].Pot_Value_graph[MixerColumn + 12], NFX2[NFX2presetNr].Pot_Value_graph[MixerColumn + 12], noteNames[MixerColumn+8], trackColor[desired_instrument]);
        }
      }
      break;
  }
...
void NoteFX2_Page_Static() {
  ...
  for (int touchX = 1; touchX < 5; touchX++) {
    drawPot(touchX * 4 - 1, CTRL_ROW_1, NFX2[NFX2presetNr].Pot_Value_graph[touchX + 3], NFX2[NFX2presetNr].Pot_Value_graph[touchX + 3], noteNames[touchX -1], trackColor[desired_instrument]);
  }
  for (int touchX = 1; touchX < 5; touchX++) {
    drawPot(touchX * 4 - 1, CTRL_ROW_2, NFX2[NFX2presetNr].Pot_Value_graph[touchX + 7], NFX2[NFX2presetNr].Pot_Value_graph[touchX + 7], noteNames[touchX +3], trackColor[desired_instrument]);
  }
  for (int touchX = 1; touchX < 5; touchX++) {
    drawPot(touchX * 4 - 1, CTRL_ROW_3, NFX2[NFX2presetNr].Pot_Value_graph[touchX + 11], NFX2[NFX2presetNr].Pot_Value_graph[touchX + 11], noteNames[touchX +7], trackColor[desired_instrument]);
  }
}
