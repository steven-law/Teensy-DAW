...
AudioMixer4 pl9mixer1;                        //xy=738.5000076293945,2045.0000286102295
...
AudioConnection patchCord41(pl7drum1, 0, pl7mixer1, 0);
...
AudioConnection patchCord69(pl7filter2, 0, pl7envelope1, 0);
AudioConnection patchCord70(pl7dc1, 0, pl7wavefolder1, 1);
AudioConnection patchCord71(pl1mixer2, envelope2);
AudioConnection patchCord72(pl7biquad1, pl7envelope4);
AudioConnection patchCord73(pl3envelope2, 0, pl3filter1, 1);
AudioConnection patchCord74(pl7waveformMod2, pl7envelope3);
AudioConnection patchCord75(drummixer4, pl2amp2);
AudioConnection patchCord76(pl8filter1, pl8envelope1);
AudioConnection patchCord77(pl3filter1, 0, pl3mixer1, 0);
AudioConnection patchCord78(pl3filter1, 1, pl3mixer1, 1);
AudioConnection patchCord79(pl3filter1, 2, pl3mixer1, 2);
AudioConnection patchCord80(pl6mixer1, pl6envelope1);
AudioConnection patchCord81(pl5mixer1, pl5envelope1);
AudioConnection patchCord82(envelope2, bitcrusher1);
AudioConnection patchCord83(pl4drummixer4, pl4amp2);
AudioConnection patchCord84(pl7envelope1, 0, pl7mixer1, 1);
AudioConnection patchCord85(bitcrusher1, 0, pl1mixer3, 0);
AudioConnection patchCord86(pl7envelope4, 0, pl7mixer1, 3);
AudioConnection patchCord87(pl7envelope3, 0, pl7mixer1, 2);
AudioConnection patchCord88(pl5envelope1, pl5amp2);
AudioConnection patchCord89(pl2amp2, pl2amp);
AudioConnection patchCord90(pl3mixer1, pl3envelope1);
AudioConnection patchCord91(pl6envelope1, pl6amp2);
AudioConnection patchCord92(pl8envelope1, pl8amp2);
AudioConnection patchCord93(pl14amp2, pl14amp);
AudioConnection patchCord94(pl12amp2, pl12amp);
AudioConnection patchCord95(pl11amp2, pl11amp);
AudioConnection patchCord96(pl16amp2, pl16amp);
AudioConnection patchCord97(pl13amp2, pl13amp);
AudioConnection patchCord98(pl10amp2, pl10amp);
AudioConnection patchCord99(pl15amp2, pl15amp);
AudioConnection patchCord100(pl4amp2, pl4amp);
AudioConnection patchCord101(pl3envelope1, pl3amp2);
AudioConnection patchCord102(pl1delay1, 0, pl1filter3, 0);
AudioConnection patchCord103(pl1mixer3, pl1delay1);
AudioConnection patchCord104(pl1mixer3, pl1amp2);
AudioConnection patchCord105(pl1filter3, 2, pl1mixer3, 1);
AudioConnection patchCord106(pl9amp2, pl9amp);
AudioConnection patchCord107(pl8amp2, pl8amp);
AudioConnection patchCord108(pl9mixer1, pl9amp2);
AudioConnection patchCord109(pl7amp2, pl7amp);
AudioConnection patchCord110(pl7mixer2, 0, pl7mixer3, 1);
AudioConnection patchCord111(pl2amp, pl2FX3);
AudioConnection patchCord112(pl2amp, pl2dry);
AudioConnection patchCord113(pl2amp, pl2FX1);
AudioConnection patchCord114(pl2amp, pl2FX2);
AudioConnection patchCord115(pl6amp2, pl6amp);
AudioConnection patchCord116(pl3amp2, pl3amp);
AudioConnection patchCord117(pl7mixer1, 0, pl7mixer3, 0);
AudioConnection patchCord118(pl5amp2, pl5amp);
AudioConnection patchCord119(pl4amp, pl4dry);
AudioConnection patchCord120(pl4amp, pl4FX1);
AudioConnection patchCord121(pl4amp, pl4FX2);
AudioConnection patchCord122(pl4amp, pl4FX3);
AudioConnection patchCord123(pl11amp, pl11dry);
AudioConnection patchCord124(pl11amp, pl11FX1);
AudioConnection patchCord125(pl11amp, pl11FX2);
AudioConnection patchCord126(pl11amp, pl11FX3);
AudioConnection patchCord127(pl10amp, pl10dry);
AudioConnection patchCord128(pl10amp, pl10FX1);
AudioConnection patchCord129(pl10amp, pl10FX2);
AudioConnection patchCord130(pl10amp, pl10FX3);
AudioConnection patchCord131(pl16amp, pl16dry);
AudioConnection patchCord132(pl16amp, pl16FX1);
AudioConnection patchCord133(pl16amp, pl16FX2);
AudioConnection patchCord134(pl16amp, pl16FX3);
AudioConnection patchCord135(pl12amp, pl12dry);
AudioConnection patchCord136(pl12amp, pl12FX1);
AudioConnection patchCord137(pl12amp, pl12FX2);
AudioConnection patchCord138(pl12amp, pl12FX3);
AudioConnection patchCord139(pl15amp, pl15dry);
AudioConnection patchCord140(pl15amp, pl15FX1);
AudioConnection patchCord141(pl15amp, pl15FX2);
AudioConnection patchCord142(pl15amp, pl15FX3);
AudioConnection patchCord143(pl13amp, pl13FX3);
AudioConnection patchCord144(pl13amp, pl13FX2);
AudioConnection patchCord145(pl13amp, pl13FX1);
AudioConnection patchCord146(pl13amp, pl13dry);
AudioConnection patchCord147(pl14amp, pl14dry);
AudioConnection patchCord148(pl14amp, pl14FX1);
AudioConnection patchCord149(pl14amp, pl14FX2);
AudioConnection patchCord150(pl14amp, pl14FX3);
AudioConnection patchCord151(pl8amp, pl8dry);
AudioConnection patchCord152(pl8amp, pl8FX1);
AudioConnection patchCord153(pl8amp, pl8FX2);
AudioConnection patchCord154(pl8amp, pl8FX3);
AudioConnection patchCord155(pl9amp, pl9dry);
AudioConnection patchCord156(pl9amp, pl9FX1);
AudioConnection patchCord157(pl9amp, pl9FX2);
AudioConnection patchCord158(pl9amp, pl9FX3);
AudioConnection patchCord159(pl1amp2, pl1amp);
AudioConnection patchCord160(pl7amp, pl7dry);
AudioConnection patchCord161(pl7amp, pl7FX1);
AudioConnection patchCord162(pl7amp, pl7FX2);
AudioConnection patchCord163(pl7amp, pl7FX3);
AudioConnection patchCord164(pl3amp, pl3dry);
AudioConnection patchCord165(pl3amp, pl3FX1);
AudioConnection patchCord166(pl3amp, pl3FX2);
AudioConnection patchCord167(pl3amp, pl3FX3);
AudioConnection patchCord168(pl5amp, pl5dry);
AudioConnection patchCord169(pl5amp, pl5FX1);
AudioConnection patchCord170(pl5amp, pl5FX2);
AudioConnection patchCord171(pl5amp, pl5FX3);
AudioConnection patchCord172(pl6amp, pl6dry);
AudioConnection patchCord173(pl6amp, pl6FX1);
AudioConnection patchCord174(pl6amp, pl6FX2);
AudioConnection patchCord175(pl6amp, pl6FX3);
AudioConnection patchCord176(pl7mixer3, pl7amp2);
AudioConnection patchCord177(pl2FX2, 0, FX2mixer1, 1);
AudioConnection patchCord178(pl2FX3, 0, FX3mixer1, 1);
AudioConnection patchCord179(pl2dry, 0, mixer5, 1);
AudioConnection patchCord180(pl2FX1, 0, FX1mixer1, 1);
AudioConnection patchCord181(pl4FX2, 0, FX2mixer1, 3);
AudioConnection patchCord182(pl4FX3, 0, FX3mixer1, 3);
AudioConnection patchCord183(pl4dry, 0, mixer5, 3);
AudioConnection patchCord184(pl4FX1, 0, FX1mixer1, 3);
AudioConnection patchCord185(pl1amp, pl1dry);
AudioConnection patchCord186(pl1amp, pl1FX1);
AudioConnection patchCord187(pl1amp, pl1FX2);
AudioConnection patchCord188(pl1amp, pl1FX3);
AudioConnection patchCord189(pl14FX3, 0, FX3mixer6, 1);
AudioConnection patchCord190(pl14FX2, 0, FX2mixer6, 1);
AudioConnection patchCord191(pl14dry, 0, drymixer3, 1);
AudioConnection patchCord192(pl8dry, 0, mixer6, 3);
AudioConnection patchCord193(pl8FX1, 0, FX1mixer2, 3);
AudioConnection patchCord194(pl10dry, 0, mixer10, 1);
AudioConnection patchCord195(pl14FX1, 0, FX1mixer6, 1);
AudioConnection patchCord196(pl8FX2, 0, FX2mixer2, 3);
AudioConnection patchCord197(pl8FX3, 0, FX3mixer2, 3);
AudioConnection patchCord198(pl10FX1, 0, FX1mixer4, 1);
AudioConnection patchCord199(pl10FX2, 0, FX2mixer4, 1);
AudioConnection patchCord200(pl16FX3, 0, FX3mixer6, 3);
AudioConnection patchCord201(pl10FX3, 0, FX3mixer4, 1);
AudioConnection patchCord202(pl13FX3, 0, FX3mixer6, 0);
AudioConnection patchCord203(pl16FX2, 0, FX2mixer6, 3);
AudioConnection patchCord204(pl13FX2, 0, FX2mixer6, 0);
AudioConnection patchCord205(pl16dry, 0, drymixer3, 3);
AudioConnection patchCord206(pl9dry, 0, mixer10, 0);
AudioConnection patchCord207(pl16FX1, 0, FX1mixer6, 3);
AudioConnection patchCord208(pl9FX1, 0, FX1mixer4, 0);
AudioConnection patchCord209(pl9FX2, 0, FX2mixer4, 0);
AudioConnection patchCord210(pl13dry, 0, drymixer3, 0);
AudioConnection patchCord211(pl11dry, 0, mixer10, 2);
AudioConnection patchCord212(pl13FX1, 0, FX1mixer6, 0);
AudioConnection patchCord213(pl11FX2, 0, FX2mixer4, 2);
AudioConnection patchCord214(pl11FX3, 0, FX3mixer4, 2);
AudioConnection patchCord215(pl9FX3, 0, FX3mixer4, 0);
AudioConnection patchCord216(pl12dry, 0, mixer10, 3);
AudioConnection patchCord217(pl11FX1, 0, FX1mixer4, 2);
AudioConnection patchCord218(pl15FX3, 0, FX3mixer6, 2);
AudioConnection patchCord219(pl15FX2, 0, FX2mixer6, 2);
AudioConnection patchCord220(pl7dry, 0, mixer6, 2);
AudioConnection patchCord221(pl7FX2, 0, FX2mixer2, 2);
AudioConnection patchCord222(pl7FX3, 0, FX3mixer2, 2);
AudioConnection patchCord223(pl15dry, 0, drymixer3, 2);
AudioConnection patchCord224(pl7FX1, 0, FX1mixer2, 2);
AudioConnection patchCord225(pl15FX1, 0, FX1mixer6, 2);
AudioConnection patchCord226(pl12FX1, 0, FX1mixer4, 3);
AudioConnection patchCord227(pl12FX2, 0, FX2mixer4, 3);
AudioConnection patchCord228(pl3dry, 0, mixer5, 2);
AudioConnection patchCord229(pl3FX1, 0, FX1mixer1, 2);
AudioConnection patchCord230(pl3FX2, 0, FX2mixer1, 2);
AudioConnection patchCord231(pl12FX3, 0, FX3mixer4, 3);
AudioConnection patchCord232(pl3FX3, 0, FX3mixer1, 2);
AudioConnection patchCord233(pl6FX1, 0, FX1mixer2, 1);
AudioConnection patchCord234(pl6dry, 0, mixer6, 1);
AudioConnection patchCord235(pl6FX2, 0, FX2mixer2, 1);
AudioConnection patchCord236(pl5FX3, 0, FX3mixer2, 0);
AudioConnection patchCord237(pl6FX3, 0, FX3mixer2, 1);
AudioConnection patchCord238(pl5FX1, 0, FX1mixer2, 0);
AudioConnection patchCord239(pl5dry, 0, mixer6, 0);
AudioConnection patchCord240(pl5FX2, 0, FX2mixer2, 0);
AudioConnection patchCord241(pl1FX3, 0, FX3mixer1, 0);
AudioConnection patchCord242(pl1dry, 0, mixer5, 0);
AudioConnection patchCord243(pl1FX1, 0, FX1mixer1, 0);
AudioConnection patchCord244(pl1FX2, 0, FX2mixer1, 0);
AudioConnection patchCord245(mixer6, 0, drymixer2, 1);
AudioConnection patchCord246(FX2mixer1, 0, FX2mixer3, 0);
AudioConnection patchCord247(mixer5, 0, drymixer2, 0);
AudioConnection patchCord248(FX3mixer2, 0, FX3mixer3, 1);
AudioConnection patchCord249(FX1mixer1, 0, FX1mixer3, 0);
AudioConnection patchCord250(FX2mixer2, 0, FX2mixer3, 1);
AudioConnection patchCord251(FX1mixer2, 0, FX1mixer3, 1);
AudioConnection patchCord252(FX3mixer1, 0, FX3mixer3, 0);
AudioConnection patchCord253(FX2mixer4, 0, FX2mixer3, 2);
AudioConnection patchCord254(FX1mixer6, 0, FX1mixer3, 3);
AudioConnection patchCord255(drymixer3, 0, drymixer2, 3);
AudioConnection patchCord256(FX3mixer6, 0, FX3mixer3, 3);
AudioConnection patchCord257(FX2mixer6, 0, FX2mixer3, 3);
AudioConnection patchCord258(FX3mixer4, 0, FX3mixer3, 2);
AudioConnection patchCord259(FX1mixer4, 0, FX1mixer3, 2);
AudioConnection patchCord260(mixer10, 0, drymixer2, 2);
AudioConnection patchCord261(drymixer2, 0, drymixer1, 0);
AudioConnection patchCord262(FX2mixer3, 0, FX2mixer5, 0);
AudioConnection patchCord263(FX3mixer3, 0, FX3mixer5, 0);
AudioConnection patchCord264(FX1mixer3, 0, FX1mixer5, 0);
AudioConnection patchCord265(FX3mixer5, 0, dlmixer1, 0);
AudioConnection patchCord266(drymixer1, 0, mixer9, 0);
AudioConnection patchCord267(FX1mixer5, reverb1);
AudioConnection patchCord268(FX2mixer5, bitcrusher2);
AudioConnection patchCord269(reverb1, 0, mixer9, 1);
AudioConnection patchCord270(bitcrusher2, 0, mixer9, 2);
AudioConnection patchCord271(dlfilter1, 2, dlmixer1, 1);
AudioConnection patchCord272(dldelay1, 0, dlfilter1, 0);
AudioConnection patchCord273(dlmixer1, dldelay1);
AudioConnection patchCord274(dlmixer1, 0, mixer9, 3);
AudioConnection patchCord275(i2s2, 0, amp1, 0);
AudioConnection patchCord276(mixer9, 0, mixer11, 0);
AudioConnection patchCord277(amp1, 0, mixer11, 1);
AudioConnection patchCord278(amp1, queue1);
AudioConnection patchCord279(amp1, peak1);
AudioConnection patchCord280(mixer11, 0, i2s1, 0);
AudioConnection patchCord281(mixer11, 0, i2s1, 1);
