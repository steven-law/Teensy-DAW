...
void FX2Bitcrush_static() {
  ...
  drawPot(CTRL_COL_0, 0, fx2samplerate_graph, fx2samplerate, "SRate", trackColor[desired_instrument]);
  drawPot(CTRL_COL_1, 0, fx2bitcrush_graph, fx2bitcrush, "Crush", trackColor[desired_instrument]);
}
...
void FX2Bitcrush_dynamic() {
  ...
  if (enc_moved[1]) {
    ...
    drawPot_2(CTRL_COL_1, 0, fx2bitcrush_graph, fx2bitcrush, "Crush", trackColor[desired_instrument]);
  }
