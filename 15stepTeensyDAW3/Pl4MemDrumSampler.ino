    ...
    if (gridTouchY == 3) {
      for (int touchX = 1; touchX < 5; touchX++) {
        if (gridTouchX == touchX * 3) {
          ...
          drawbarH(touchX * 3, 3, Pl4Vol_rnd[touchX - 1], Pl4Controls[touchX - 1], ILI9341_BLUE);
        }
      }
    }
    if (gridTouchY == 7) {
      for (int touchX = 1; touchX < 5; touchX++) {
        if (gridTouchX == touchX * 3) {
          ...
          drawbarH(touchX * 3, 7, Pl4Vol_rnd[touchX + 3], Pl4Controls[touchX + 3], ILI9341_RED);
        }
      }
    }
    if (gridTouchY == 11) {
      for (int touchX = 1; touchX < 5; touchX++) {
        if (gridTouchX == touchX * 3) {
          ...
          drawbarH(touchX * 3, 11, Pl4Vol_rnd[touchX + 7], Pl4Controls[touchX + 7], ILI9341_MAGENTA);
        }
      }
    }
  }
